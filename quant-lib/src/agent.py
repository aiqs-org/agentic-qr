...
- Maintain a typed catalog of available objects
- Annotate catalogs with researcher findings
    ...
    try:
        response = client.chat.completions.create(
            ...
            messages=[
                ...
                {"role": "user", "content": f"Enrich this catalog with a research_context field per instrument.\nCatalog:\n{json.dumps(catalog, indent=2)}\n\nResearch:\n{knowledge}\n\nReturn ONLY valid JSON."},
            ],
        )
