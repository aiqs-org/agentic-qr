...
## Does
- Reads shared/data/market/*.json (Alpaca OHLCV daily)
- Reads shared/data/macro/*.json (FRED series)
- Builds Equity instrument objects per symbol
- Builds Bar objects (1-DAY LAST EXTERNAL) per symbol
